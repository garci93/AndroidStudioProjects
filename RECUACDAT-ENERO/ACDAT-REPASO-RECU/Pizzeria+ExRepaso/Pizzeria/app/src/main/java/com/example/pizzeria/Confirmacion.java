...
public class Confirmacion extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        Intent confirmar = new Intent(this, Principal.class);
